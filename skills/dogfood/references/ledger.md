...
| activate | id, revision, run: active recorded run scoped to the finding project and started after application, evidence_ref proving the version loaded. |
| reuse | id, revision, session: active recorded run scoped to the finding project and started after application, evidence_ref from later relevant work. |
